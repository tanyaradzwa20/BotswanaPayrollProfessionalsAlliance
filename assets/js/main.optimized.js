// BPPA Website - Optimized JavaScript
// Using event delegation, throttling, and efficient DOM access
...
(function() {
    ...
    if (heroSlides.length > 0 && heroPrevBtn && heroNextBtn) {
        ...
        function updateHeroSlide(index) {
            ...
            if (heroIndicators[currentHeroSlide]) heroIndicators[currentHeroSlide].classList.remove('active');
        ...
        function nextHeroSlide() {
            updateHeroSlide((currentHeroSlide + 1) % slideCount);
        }

        function prevHeroSlide() {
            updateHeroSlide((currentHeroSlide - 1 + slideCount) % slideCount);
        }
        ...
        document.addEventListener('visibilitychange', function() {
            document.hidden ? stopHeroAutoSlide() : startHeroAutoSlide();
        });
    ...
    const handleScroll = throttle(function() {
        ...
        if (elements.navbar) {
            elements.navbar.classList.toggle('scrolled', scroll > 100);
        }
        
        if (elements.scrollToTop) {
            elements.scrollToTop.classList.toggle('visible', scroll > 50);
        }
    }, 100);
    ...
    function initCarousel() {
        ...
        function moveCarousel(index, useTransition) {
            ...
            track.style.transform = 'translateX(-' + ((metrics.cardWidth + metrics.gap) * index) + 'px)';
        ...
        function startAutoSlide() {
            stopAutoSlide();
            autoSlideInterval = setInterval(handleNext, 3000);
        }
